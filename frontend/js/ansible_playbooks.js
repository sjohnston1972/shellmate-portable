/**
 * ansible_playbooks.js — The runner's own playbooks and the ones written here, and the run that watches itself (#586).
 *
...
(function () {
  ...
  function render() {
    const body = document.getElementById('av-playbooks-body');
    if (!body) return;
    view.clear(body);
    body.appendChild(view.empty('Being built.'));
  }

  view.area('playbooks', { onShow: render });
})();
