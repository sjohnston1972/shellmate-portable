...
| Terminal Behaviour | Scrollback, right-click paste, copy on select, screen-reader mode — plus rendering, paste protection and pacing, and the destructive-command confirmation |
